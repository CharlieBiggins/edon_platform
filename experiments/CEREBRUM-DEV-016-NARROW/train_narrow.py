#!/usr/bin/env python3
"""Continue the DEV-015 step-12 adapter with weighted narrow repair."""
...
from dev016_common import read_jsonl, sha256_path, sha256_tree
...
def main() -> int:
    ...
    manifest = {
        "schema_version": "cerebrum-dev016-narrow-training-manifest.v1",
        ...
        "claim_boundary": "Fresh synthetic delayed-evidence and exact-state continuation only; no confirmed full regression, transfer, production, authority, or IGI claim.",
    }
