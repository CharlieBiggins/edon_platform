...
from dev016_common import CONFIG, ROOT, candidate_specs, read_json, read_jsonl, sha256_path, sha256_tree, write_json
...
def main() -> int:
    ...
    result = {
        "schema_version": "cerebrum-dev016-development-selection.v1",
