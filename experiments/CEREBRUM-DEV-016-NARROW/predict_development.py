#!/usr/bin/env python3
"""Freeze development predictions for the two narrow-repair checkpoints."""
...
from dev016_common import BASE, CONFIG, ROOT, candidate_specs, read_json, sha256_path, sha256_tree, write_json
...
def main() -> int:
    ...
    for candidate in candidate_specs(config):
        ...
        manifest.update({
            "schema_version": "cerebrum-dev016-development-prediction-manifest.v1",
    ...
    freeze = {
        "schema_version": "cerebrum-dev016-development-prediction-freeze.v1",
        "protocol_id": config["protocol_id"],
