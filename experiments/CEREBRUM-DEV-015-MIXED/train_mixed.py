#!/usr/bin/env python3
"""Continue the selected adapter with weighted mixed-task replay."""
...
from dev015_common import read_jsonl, sha256_path, sha256_tree
...
def main() -> int:
    ...
    manifest = {
        "schema_version": "cerebrum-dev015-mixed-training-manifest.v1",
        ...
        "claim_boundary": "Mixed project-authored synthetic retention continuation only; no confirmed full regression, transfer, production, authority, or IGI claim.",
    }
