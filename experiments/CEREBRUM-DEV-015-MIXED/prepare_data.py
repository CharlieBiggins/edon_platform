#!/usr/bin/env python3
"""Prepare mixed replay, checkpoint selection, and untouched confirmation."""
...
from dev015_common import ACTIONNET, ROOT, canonical, read_json, read_jsonl, sha256_path, summarize, write_json, write_jsonl
...
def prepare() -> dict[str, Any]:
    ...
    if qualification.get("status") != "READY_FOR_CEREBRUM_DEV015_MIXED_RETENTION_REPAIR":
        raise ValueError("ACTIONNET-DATA-QUAL-015 is not qualified")
    sources = {
    ...
    manifest = {
        "schema_version": "cerebrum-dev015-mixed-data-manifest.v1",
        "protocol_id": "CEREBRUM-DEV-015-MIXED",
        ...
        "dev014_cases_used_for_training": False,
