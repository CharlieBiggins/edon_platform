#!/usr/bin/env python3
"""Freeze development predictions for the two causal-repair checkpoints."""
...
from dev017_common import BASE, CONFIG, ROOT, candidate_specs, read_json, sha256_path, sha256_tree, write_json
...
def main() -> int:
    ...
    for candidate in candidate_specs(config):
        ...
        manifest.update({
            "schema_version": "cerebrum-dev017-development-prediction-manifest.v1",
    ...
    freeze = {
        "schema_version": "cerebrum-dev017-development-prediction-freeze.v1",
        "protocol_id": config["protocol_id"],
