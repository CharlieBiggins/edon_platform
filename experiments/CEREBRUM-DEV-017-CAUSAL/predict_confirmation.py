...
from dev017_common import BASE, CONFIG, ROOT, artifact_root, candidate_specs, read_json, sha256_path, sha256_tree, write_json
...
def main() -> int:
    ...
    manifest.update({
        "schema_version": "cerebrum-dev017-confirmation-prediction-manifest.v1",
    ...
    freeze = {
        "schema_version": "cerebrum-dev017-confirmation-prediction-freeze.v1",
        "protocol_id": config["protocol_id"],
        "selected_candidate_id": candidate_id,
        "selected_step": candidate["step"],
        "selection_sha256": sha256_path(selection_path),
