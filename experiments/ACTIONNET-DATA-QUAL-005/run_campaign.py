#!/usr/bin/env python3
"""Generate and freeze ACTIONNET-DATA-QUAL-005."""
...
def main() -> int:
    ...
    write_json(lineages_path, {"schema_version": "actionnet-lineage-registry.v5", "records": generated["lineages"]})
    ...
    dataset_manifest = {
        "schema_version": "actionnet-eventnet-dataset-manifest.v5",
        "dataset_id": DATASET_ID,
        "parent_result": "ACTIONNET-DATA-QUAL-004-result-v1.0.0",
        "counts": {
        ...
        "claim_boundary": "Fresh-lineage project-authored synthetic repair corpus for internal EventNet learning only.",
    }
    ...
    report = {
        "schema_version": "actionnet-data-qualification-report.v5",
        "result_id": RESULT_ID,
        "status": status,
        "controls": controls,
        ...
        "binding_authority": False,
        "claim_boundary": "Qualified for the separate CEREBRUM-DEV-004 repair campaign; no public, protected, real-institution, autonomous-authority, or production claim.",
    }
