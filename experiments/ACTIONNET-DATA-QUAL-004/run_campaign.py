#!/usr/bin/env python3
"""Generate and freeze ACTIONNET-DATA-QUAL-004."""
...
def main() -> int:
    ...
    write_json(lineages_path, {"schema_version": "actionnet-lineage-registry.v4", "records": generated["lineages"]})
    ...
    dataset_manifest = {
        "schema_version": "actionnet-eventnet-dataset-manifest.v4",
        "dataset_id": DATASET_ID,
        "parent_result": "ACTIONNET-DATA-QUAL-003-result-v1.0.0",
        "counts": {
        ...
        "claim_boundary": "Project-authored synthetic event-queue corpus for internal multi-actor institutional learning only.",
    }
    ...
    report = {
        "schema_version": "actionnet-data-qualification-report.v4",
        "result_id": RESULT_ID,
        "status": status,
        "controls": controls,
        ...
        "binding_authority": False,
        "claim_boundary": "Qualified for a separate internal EventNet development campaign; no public, protected, real-institution, autonomous-authority, or production claim.",
    }
