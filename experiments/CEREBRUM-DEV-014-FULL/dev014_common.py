...
CONFIG = ROOT / "configs" / "dev014-full.json"
EXPERIMENTS = ROOT.parent
ACTIONNET = EXPERIMENTS / "ACTIONNET-DATA-QUAL-014"
...
def selected_adapter(config: dict[str, Any]) -> Path:
    return parent_artifact_root(config) / f"checkpoint-{config['selected_step']}"
