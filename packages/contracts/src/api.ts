...
export function openApiDocument(serverUrl = 'http://localhost:8787') {
  const routes = ['/v1/events', '/v1/incidents/{id}', '/v1/state/{scopeId}', '/v1/proposals', '/v1/reviews', '/v1/shadow-evaluations', '/v1/outcomes', '/v1/receipts/{id}', '/v1/reconstructions/{incidentId}', '/v1/model-releases', '/v1/model-releases/{releaseId}', '/v1/model-releases/{releaseId}/capabilities', '/v1/model-releases/{releaseId}/evaluations'];
