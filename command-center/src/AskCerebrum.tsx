...
export default function AskCerebrum(props: AskCerebrumProps) {
  ...
  const [collapsedPane, setCollapsedPane] = useState<'chat' | 'workspace' | null>('workspace');
  ...
  }, [chatWidth, splitPreset, drawerWidth]);
  ...
  function openInspector(tab: InspectorTab, citation?: string) {
    ...
    if (collapsedPane === 'workspace') setContextDrawerOpen(true);
  }
